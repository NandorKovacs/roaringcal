...
Open `index.html` in your browser. It will automatically query the backend at `http://localhost:8000/last-updated` (or your configured port) and display the "Last updated" time in the header.
